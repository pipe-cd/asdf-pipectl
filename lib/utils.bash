...
# NOTE: You might want to remove this if pipectl is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if pipectl has other means of determining installable versions.
  list_github_tags
}
